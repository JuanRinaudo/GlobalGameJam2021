...
public class GirlModelAnimator { 
    ...
    public const int DEATH_TRIGGER_HASH = -414722770;
    public const string IDLE = "Idle";
    public const int IDLE_HASH = 2081823275;
    public const string IDLE_0 = "Idle 0";
    public const int IDLE_0_HASH = 2039906036;
    public const string JOGGING = "Jogging";
    public const int JOGGING_HASH = 1727557212;
    ...
    public const int DEATH_HASH = 646380074;
}
